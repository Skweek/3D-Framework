...
/*$ preserve end $*/
        ...
        case FMOD_ERR_DSP_DONTREAD:              return "DSP return code from a DSP shouldiprocess callback.  Tells mixer not to call the read callback.";
        ...
        case FMOD_ERR_DSP_GOIDLE:                return "DSP return code from a DSP shouldiprocess callback.  Tells mixer silence would be produced from read, so go idle.  Use this to optimize the DSP chain.";
